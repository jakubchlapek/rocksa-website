<div x-data="{
    ...
    <div class="relative rounded-2xl w-full h-[20rem] overflow-hidden shadow-lg">
        <img src="data:image/{{ pathinfo($data['main_image'], PATHINFO_EXTENSION) }};base64,{{ $data['main_image'] }}" alt="Main Image" onerror="this.src='/static/amethyst.jpg'" class="transition-all duration-200 hover:shadow-lg hover:scale-[102%] object-cover w-full h-full rounded-xl">
    </div>
