        ...
        $rocks = [
            'Native metals' => [
                [
                    ...
                    'rarity' => 'Rare',
                    'price' => 5000,
                    'main_image' => base64_encode(File::get(public_path('static/gold.jpg'))),
                ],
                [
                    'title' => 'Diamond',
                    'description' => 'A precious gemstone renowned for its hardness and brilliance.',
                    'main_mineral' => 'Carbon',
                    'treatment' => 'Polished',
                    ...
                    'price' => 15000,
                    'main_image' => base64_encode(File::get(public_path('static/diamond.jpg'))),
                ],
                [
                    'title' => 'Silver',
                    ...
                    'rarity' => 'Common',
                    'price' => 100,
                    'main_image' => base64_encode(File::get(public_path('static/silver.jpg'))),
                ],
            ],
            'Silicates' => [
                [
                    ...
                    'rarity' => 'Common',
                    'price' => 20,
                    'main_image' => base64_encode(File::get(public_path('static/quartz.jpg'))),
                ],
            ],
            'Metal alloys' => [
                [
                    ...
                    'rarity' => 'Common',
                    'price' => 15,
                    'main_image' => base64_encode(File::get(public_path('static/bronze.jpg'))),
                ],
            ],
            'Gases' => [
                [
                    ...
                    'rarity' => 'Common',
                    'price' => 0.2,
                    'main_image' => base64_encode(File::get(public_path('static/oxygen.jpg'))),
                ],
            ],
            'Simple sulfides' => [
                [
                    ...
                    'rarity' => 'Common',
                    'price' => 10,
                    'main_image' => base64_encode(File::get(public_path('static/pyrite.jpg'))),
                ],
            ],
            'Arsenides, tellurides, selenides' => [
                [
                    ...
                    'rarity' => 'Uncommon',
                    'price' => 25,
                    'main_image' => base64_encode(File::get(public_path('static/arsenopyrite.jpg'))),
                ],
            ],
            'Chlorides' => [
                [
                    ...
                    'rarity' => 'Common',
                    'price' => 5,
                    'main_image' => base64_encode(File::get(public_path('static/halite.jpg'))),
                ],
            ],
            'Fluorides' => [
                [
                    ...
                    'rarity' => 'Common',
                    'price' => 15,
                    'main_image' => base64_encode(File::get(public_path('static/fluorite.jpg'))),
                ],
            ],
            'Simple oxides' => [
                [
                    ...
                    'rarity' => 'Common',
                    'price' => 12,
                    'main_image' => base64_encode(File::get(public_path('static/hematite.jpg'))),
                ],
            ],
            'Complex oxides' => [
                [
                    ...
                    'rarity' => 'Uncommon',
                    'price' => 100,
                    'main_image' => base64_encode(File::get(public_path('static/spinel.jpg'))),
                ],
            ],
            'Nesosilicates' => [
                [
                    ...
                    'rarity' => 'Common',
                    'price' => 50,
                    'main_image' => base64_encode(File::get(public_path('static/garnet.jpg'))),
                ],
            ],
            'Sorosilicates' => [
                [
                    ...
                    'rarity' => 'Uncommon',
                    'price' => 30,
                    'main_image' => base64_encode(File::get(public_path('static/epidote.jpg'))),
                ],
            ],
        ];
